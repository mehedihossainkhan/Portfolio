        ...
        <div className="container sm:px-10 m-auto px-5 flex flex-wrap items-center justify-between gap-6 py-20">
            <div className="flex flex-col">
                ...
                <div className="flex gap-4 mt-3">
                    ...
                    <a href = {mydata.linkedin} className="p-3 bg-[#1f2a41] rounded-full overflow-clip cursor-pointer">
                    ...
                    <a href = {mydata.twitter} className="p-3 bg-[#1f2a41] rounded-full overflow-clip cursor-pointer">
