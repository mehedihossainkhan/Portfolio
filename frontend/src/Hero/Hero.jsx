...
function Hero (){
    ...
    return (
        <>
            <div className="container sm:px-10 px-5 flex md:flex-row flex-col-reverse md:justify-between justify-center items-center h-full min-h-[18rem] gap-4">
                <div className="flex flex-col justify-between gap-5 max-w-[43rem] md:items-start items-center">
                    <h1 className="lg:text-7xl sm:text-5xl text-4xl"><span className="custom-font font-bold ">Mehedi Hossain Khan</span></h1>
                    <p className="sm:text-lg text-md text-neutral-400 md:text-start text-center">Hi! I am <a href="#" className="underline text-white ">Mehedi Hossain Khan.</a> A skilled web developer with expertise in building responsive, user-friendly websites and applications.</p>
                </div>
                <div className="bubble relative  flex justify-center items-center flex-shrink-0">
                    <div className=" md:h-[20rem] md:w-[20rem]   h-[18rem] w-[18rem] flex justify-center items-center rounded-full overflow-hidden">
                        <img src={profileImage} alt="@mehedihossain" className="h-full w-full object-cover z-10"/>
                    </div>
                    <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg" className="absolute z-0 inset-0 scale-[130%]">
                        <g>
                            <svg
                            className="blobs"
